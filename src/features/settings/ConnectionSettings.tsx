  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-background border border-border/60">
        <span
          className={`w-2 h-2 shrink-0 ${STATUS_COLORS[connectionState]}`}
        />
      ...
      {/* File Proxy — API Key + URL for vaani_core cockpit-proxy */}
      ...
      <p className="text-[10px] text-muted-foreground/70 leading-relaxed">
        API key for remote file access via vaani_core. Required for file
        browser, memory, and workspace in shared mode.
      </p>
        ...
        <>
          ...
          >
            <RotateCw
              size={12}
              aria-hidden="true"
              className={gatewayRestarting ? "animate-spin" : ""}
            />
